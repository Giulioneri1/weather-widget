# 🌦️ Weather Widget project

The aim of the project was to build a modern, **Mobile-First** weather application built with **HTML**, **CSS** and **Vanilla JavaScript**
...
├── app.js                 # Main UI logic, Event Listeners, Carousel logic
├── js/
